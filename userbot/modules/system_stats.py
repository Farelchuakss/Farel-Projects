...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"┣|• `👺 Telethon :`Ver {version.__version__} \n"
        f"┣|• `🐉 Python   :`Ver {python_version()} \n"
        f"┣|• `Branch      :`Farel-Projects \n"
        f"┣|• `Bot Ver     :`7.0 \n"
        f"┣|• `Modules     :`{len(modules)} Modules \n"
        f"╰═──────╼═⌘═╾───────═ \n\n"
        f"[REPO](https://github.com/ramadhani892/RAM-UBOT) | [Instagram](https://www.instagram.com/muhfrel_/) | [OWNER](t.me/Ramubotinfo)")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
            await alive.delete()
